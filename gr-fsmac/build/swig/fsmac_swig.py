...
class metrics_sensor(object):
    """Proxy of C++ gr::fsmac::metrics_sensor class."""
    ...
    def make(periodicity, is_coord):
        """make(uint8_t periodicity, bool is_coord) -> metrics_sensor_sptr"""
        return _fsmac_swig.metrics_sensor_make(periodicity, is_coord)

    make = staticmethod(make)
    __swig_destroy__ = _fsmac_swig.delete_metrics_sensor
    __del__ = lambda self: None
metrics_sensor_swigregister = _fsmac_swig.metrics_sensor_swigregister
metrics_sensor_swigregister(metrics_sensor)

def metrics_sensor_make(periodicity, is_coord):
    """metrics_sensor_make(uint8_t periodicity, bool is_coord) -> metrics_sensor_sptr"""
    return _fsmac_swig.metrics_sensor_make(periodicity, is_coord)

class metrics_sensor_sptr(object):
    """Proxy of C++ boost::shared_ptr<(gr::fsmac::metrics_sensor)> class."""
    ...
    def __init__(self, *args):
        """
        __init__(boost::shared_ptr<(gr::fsmac::metrics_sensor)> self) -> metrics_sensor_sptr
        __init__(boost::shared_ptr<(gr::fsmac::metrics_sensor)> self, metrics_sensor p) -> metrics_sensor_sptr
        """
        this = _fsmac_swig.new_metrics_sensor_sptr(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def __deref__(self):
        """__deref__(metrics_sensor_sptr self) -> metrics_sensor"""
        return _fsmac_swig.metrics_sensor_sptr___deref__(self)

    __swig_destroy__ = _fsmac_swig.delete_metrics_sensor_sptr
    __del__ = lambda self: None

    def make(self, periodicity, is_coord):
        """make(metrics_sensor_sptr self, uint8_t periodicity, bool is_coord) -> metrics_sensor_sptr"""
        return _fsmac_swig.metrics_sensor_sptr_make(self, periodicity, is_coord)


    def history(self):
        """history(metrics_sensor_sptr self) -> unsigned int"""
        return _fsmac_swig.metrics_sensor_sptr_history(self)


    def declare_sample_delay(self, *args):
        """
        declare_sample_delay(metrics_sensor_sptr self, int which, int delay)
        declare_sample_delay(metrics_sensor_sptr self, unsigned int delay)
        """
        return _fsmac_swig.metrics_sensor_sptr_declare_sample_delay(self, *args)


    def sample_delay(self, which):
        """sample_delay(metrics_sensor_sptr self, int which) -> unsigned int"""
        return _fsmac_swig.metrics_sensor_sptr_sample_delay(self, which)


    def output_multiple(self):
        """output_multiple(metrics_sensor_sptr self) -> int"""
        return _fsmac_swig.metrics_sensor_sptr_output_multiple(self)


    def relative_rate(self):
        """relative_rate(metrics_sensor_sptr self) -> double"""
        return _fsmac_swig.metrics_sensor_sptr_relative_rate(self)


    def start(self):
        """start(metrics_sensor_sptr self) -> bool"""
        return _fsmac_swig.metrics_sensor_sptr_start(self)


    def stop(self):
        """stop(metrics_sensor_sptr self) -> bool"""
        return _fsmac_swig.metrics_sensor_sptr_stop(self)


    def nitems_read(self, which_input):
        """nitems_read(metrics_sensor_sptr self, unsigned int which_input) -> uint64_t"""
        return _fsmac_swig.metrics_sensor_sptr_nitems_read(self, which_input)


    def nitems_written(self, which_output):
        """nitems_written(metrics_sensor_sptr self, unsigned int which_output) -> uint64_t"""
        return _fsmac_swig.metrics_sensor_sptr_nitems_written(self, which_output)


    def max_noutput_items(self):
        """max_noutput_items(metrics_sensor_sptr self) -> int"""
        return _fsmac_swig.metrics_sensor_sptr_max_noutput_items(self)


    def set_max_noutput_items(self, m):
        """set_max_noutput_items(metrics_sensor_sptr self, int m)"""
        return _fsmac_swig.metrics_sensor_sptr_set_max_noutput_items(self, m)


    def unset_max_noutput_items(self):
        """unset_max_noutput_items(metrics_sensor_sptr self)"""
        return _fsmac_swig.metrics_sensor_sptr_unset_max_noutput_items(self)


    def is_set_max_noutput_items(self):
        """is_set_max_noutput_items(metrics_sensor_sptr self) -> bool"""
        return _fsmac_swig.metrics_sensor_sptr_is_set_max_noutput_items(self)


    def set_min_noutput_items(self, m):
        """set_min_noutput_items(metrics_sensor_sptr self, int m)"""
        return _fsmac_swig.metrics_sensor_sptr_set_min_noutput_items(self, m)


    def min_noutput_items(self):
        """min_noutput_items(metrics_sensor_sptr self) -> int"""
        return _fsmac_swig.metrics_sensor_sptr_min_noutput_items(self)


    def max_output_buffer(self, i):
        """max_output_buffer(metrics_sensor_sptr self, int i) -> long"""
        return _fsmac_swig.metrics_sensor_sptr_max_output_buffer(self, i)


    def set_max_output_buffer(self, *args):
        """
        set_max_output_buffer(metrics_sensor_sptr self, long max_output_buffer)
        set_max_output_buffer(metrics_sensor_sptr self, int port, long max_output_buffer)
        """
        return _fsmac_swig.metrics_sensor_sptr_set_max_output_buffer(self, *args)


    def min_output_buffer(self, i):
        """min_output_buffer(metrics_sensor_sptr self, int i) -> long"""
        return _fsmac_swig.metrics_sensor_sptr_min_output_buffer(self, i)


    def set_min_output_buffer(self, *args):
        """
        set_min_output_buffer(metrics_sensor_sptr self, long min_output_buffer)
        set_min_output_buffer(metrics_sensor_sptr self, int port, long min_output_buffer)
        """
        return _fsmac_swig.metrics_sensor_sptr_set_min_output_buffer(self, *args)


    def pc_noutput_items(self):
        """pc_noutput_items(metrics_sensor_sptr self) -> float"""
        return _fsmac_swig.metrics_sensor_sptr_pc_noutput_items(self)


    def pc_noutput_items_avg(self):
        """pc_noutput_items_avg(metrics_sensor_sptr self) -> float"""
        return _fsmac_swig.metrics_sensor_sptr_pc_noutput_items_avg(self)


    def pc_noutput_items_var(self):
        """pc_noutput_items_var(metrics_sensor_sptr self) -> float"""
        return _fsmac_swig.metrics_sensor_sptr_pc_noutput_items_var(self)


    def pc_nproduced(self):
        """pc_nproduced(metrics_sensor_sptr self) -> float"""
        return _fsmac_swig.metrics_sensor_sptr_pc_nproduced(self)


    def pc_nproduced_avg(self):
        """pc_nproduced_avg(metrics_sensor_sptr self) -> float"""
        return _fsmac_swig.metrics_sensor_sptr_pc_nproduced_avg(self)


    def pc_nproduced_var(self):
        """pc_nproduced_var(metrics_sensor_sptr self) -> float"""
        return _fsmac_swig.metrics_sensor_sptr_pc_nproduced_var(self)


    def pc_input_buffers_full(self, *args):
        """
        pc_input_buffers_full(metrics_sensor_sptr self, int which) -> float
        pc_input_buffers_full(metrics_sensor_sptr self) -> pmt_vector_float
        """
        return _fsmac_swig.metrics_sensor_sptr_pc_input_buffers_full(self, *args)


    def pc_input_buffers_full_avg(self, *args):
        """
        pc_input_buffers_full_avg(metrics_sensor_sptr self, int which) -> float
        pc_input_buffers_full_avg(metrics_sensor_sptr self) -> pmt_vector_float
        """
        return _fsmac_swig.metrics_sensor_sptr_pc_input_buffers_full_avg(self, *args)


    def pc_input_buffers_full_var(self, *args):
        """
        pc_input_buffers_full_var(metrics_sensor_sptr self, int which) -> float
        pc_input_buffers_full_var(metrics_sensor_sptr self) -> pmt_vector_float
        """
        return _fsmac_swig.metrics_sensor_sptr_pc_input_buffers_full_var(self, *args)


    def pc_output_buffers_full(self, *args):
        """
        pc_output_buffers_full(metrics_sensor_sptr self, int which) -> float
        pc_output_buffers_full(metrics_sensor_sptr self) -> pmt_vector_float
        """
        return _fsmac_swig.metrics_sensor_sptr_pc_output_buffers_full(self, *args)


    def pc_output_buffers_full_avg(self, *args):
        """
        pc_output_buffers_full_avg(metrics_sensor_sptr self, int which) -> float
        pc_output_buffers_full_avg(metrics_sensor_sptr self) -> pmt_vector_float
        """
        return _fsmac_swig.metrics_sensor_sptr_pc_output_buffers_full_avg(self, *args)


    def pc_output_buffers_full_var(self, *args):
        """
        pc_output_buffers_full_var(metrics_sensor_sptr self, int which) -> float
        pc_output_buffers_full_var(metrics_sensor_sptr self) -> pmt_vector_float
        """
        return _fsmac_swig.metrics_sensor_sptr_pc_output_buffers_full_var(self, *args)


    def pc_work_time(self):
        """pc_work_time(metrics_sensor_sptr self) -> float"""
        return _fsmac_swig.metrics_sensor_sptr_pc_work_time(self)


    def pc_work_time_avg(self):
        """pc_work_time_avg(metrics_sensor_sptr self) -> float"""
        return _fsmac_swig.metrics_sensor_sptr_pc_work_time_avg(self)


    def pc_work_time_var(self):
        """pc_work_time_var(metrics_sensor_sptr self) -> float"""
        return _fsmac_swig.metrics_sensor_sptr_pc_work_time_var(self)


    def pc_work_time_total(self):
        """pc_work_time_total(metrics_sensor_sptr self) -> float"""
        return _fsmac_swig.metrics_sensor_sptr_pc_work_time_total(self)


    def pc_throughput_avg(self):
        """pc_throughput_avg(metrics_sensor_sptr self) -> float"""
        return _fsmac_swig.metrics_sensor_sptr_pc_throughput_avg(self)


    def set_processor_affinity(self, mask):
        """set_processor_affinity(metrics_sensor_sptr self, std::vector< int,std::allocator< int > > const & mask)"""
        return _fsmac_swig.metrics_sensor_sptr_set_processor_affinity(self, mask)


    def unset_processor_affinity(self):
        """unset_processor_affinity(metrics_sensor_sptr self)"""
        return _fsmac_swig.metrics_sensor_sptr_unset_processor_affinity(self)


    def processor_affinity(self):
        """processor_affinity(metrics_sensor_sptr self) -> std::vector< int,std::allocator< int > >"""
        return _fsmac_swig.metrics_sensor_sptr_processor_affinity(self)


    def active_thread_priority(self):
        """active_thread_priority(metrics_sensor_sptr self) -> int"""
        return _fsmac_swig.metrics_sensor_sptr_active_thread_priority(self)


    def thread_priority(self):
        """thread_priority(metrics_sensor_sptr self) -> int"""
        return _fsmac_swig.metrics_sensor_sptr_thread_priority(self)


    def set_thread_priority(self, priority):
        """set_thread_priority(metrics_sensor_sptr self, int priority) -> int"""
        return _fsmac_swig.metrics_sensor_sptr_set_thread_priority(self, priority)


    def name(self):
        """name(metrics_sensor_sptr self) -> std::string"""
        return _fsmac_swig.metrics_sensor_sptr_name(self)


    def symbol_name(self):
        """symbol_name(metrics_sensor_sptr self) -> std::string"""
        return _fsmac_swig.metrics_sensor_sptr_symbol_name(self)


    def input_signature(self):
        """input_signature(metrics_sensor_sptr self) -> io_signature_sptr"""
        return _fsmac_swig.metrics_sensor_sptr_input_signature(self)


    def output_signature(self):
        """output_signature(metrics_sensor_sptr self) -> io_signature_sptr"""
        return _fsmac_swig.metrics_sensor_sptr_output_signature(self)


    def unique_id(self):
        """unique_id(metrics_sensor_sptr self) -> long"""
        return _fsmac_swig.metrics_sensor_sptr_unique_id(self)


    def to_basic_block(self):
        """to_basic_block(metrics_sensor_sptr self) -> basic_block_sptr"""
        return _fsmac_swig.metrics_sensor_sptr_to_basic_block(self)


    def check_topology(self, ninputs, noutputs):
        """check_topology(metrics_sensor_sptr self, int ninputs, int noutputs) -> bool"""
        return _fsmac_swig.metrics_sensor_sptr_check_topology(self, ninputs, noutputs)


    def alias(self):
        """alias(metrics_sensor_sptr self) -> std::string"""
        return _fsmac_swig.metrics_sensor_sptr_alias(self)


    def set_block_alias(self, name):
        """set_block_alias(metrics_sensor_sptr self, std::string name)"""
        return _fsmac_swig.metrics_sensor_sptr_set_block_alias(self, name)


    def _post(self, which_port, msg):
        """_post(metrics_sensor_sptr self, swig_int_ptr which_port, swig_int_ptr msg)"""
        return _fsmac_swig.metrics_sensor_sptr__post(self, which_port, msg)


    def message_ports_in(self):
        """message_ports_in(metrics_sensor_sptr self) -> swig_int_ptr"""
        return _fsmac_swig.metrics_sensor_sptr_message_ports_in(self)


    def message_ports_out(self):
        """message_ports_out(metrics_sensor_sptr self) -> swig_int_ptr"""
        return _fsmac_swig.metrics_sensor_sptr_message_ports_out(self)


    def message_subscribers(self, which_port):
        """message_subscribers(metrics_sensor_sptr self, swig_int_ptr which_port) -> swig_int_ptr"""
        return _fsmac_swig.metrics_sensor_sptr_message_subscribers(self, which_port)

metrics_sensor_sptr_swigregister = _fsmac_swig.metrics_sensor_sptr_swigregister
metrics_sensor_sptr_swigregister(metrics_sensor_sptr)


metrics_sensor_sptr.__repr__ = lambda self: "<gr_block %s (%d)>" % (self.name(), self.unique_id())
metrics_sensor = metrics_sensor.make;

class snr(object):
    """Proxy of C++ gr::fsmac::snr class."""
    ...
    def make(window_size, threshold, periodicity):
        ...
        return _fsmac_swig.snr_make(window_size, threshold, periodicity)

    make = staticmethod(make)
    __swig_destroy__ = _fsmac_swig.delete_snr
    __del__ = lambda self: None
snr_swigregister = _fsmac_swig.snr_swigregister
...
class snr_sptr(object):
    """Proxy of C++ boost::shared_ptr<(gr::fsmac::snr)> class."""
    ...
    def __init__(self, *args):
        """
        __init__(boost::shared_ptr<(gr::fsmac::snr)> self) -> snr_sptr
        __init__(boost::shared_ptr<(gr::fsmac::snr)> self, snr p) -> snr_sptr
        """
        this = _fsmac_swig.new_snr_sptr(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def __deref__(self):
        ...
        return _fsmac_swig.snr_sptr___deref__(self)

    __swig_destroy__ = _fsmac_swig.delete_snr_sptr
    __del__ = lambda self: None
    ...
    def make(self, window_size, threshold, periodicity):
        ...
        return _fsmac_swig.snr_sptr_make(self, window_size, threshold, periodicity)


    def history(self):
        """history(snr_sptr self) -> unsigned int"""
        return _fsmac_swig.snr_sptr_history(self)
    ...
    def declare_sample_delay(self, *args):
        ...
        """
        return _fsmac_swig.snr_sptr_declare_sample_delay(self, *args)


    def sample_delay(self, which):
        """sample_delay(snr_sptr self, int which) -> unsigned int"""
        return _fsmac_swig.snr_sptr_sample_delay(self, which)


    def output_multiple(self):
        """output_multiple(snr_sptr self) -> int"""
        return _fsmac_swig.snr_sptr_output_multiple(self)


    def relative_rate(self):
        """relative_rate(snr_sptr self) -> double"""
        return _fsmac_swig.snr_sptr_relative_rate(self)


    def start(self):
        """start(snr_sptr self) -> bool"""
        return _fsmac_swig.snr_sptr_start(self)


    def stop(self):
        """stop(snr_sptr self) -> bool"""
        return _fsmac_swig.snr_sptr_stop(self)


    def nitems_read(self, which_input):
        """nitems_read(snr_sptr self, unsigned int which_input) -> uint64_t"""
        return _fsmac_swig.snr_sptr_nitems_read(self, which_input)


    def nitems_written(self, which_output):
        """nitems_written(snr_sptr self, unsigned int which_output) -> uint64_t"""
        return _fsmac_swig.snr_sptr_nitems_written(self, which_output)


    def max_noutput_items(self):
        """max_noutput_items(snr_sptr self) -> int"""
        return _fsmac_swig.snr_sptr_max_noutput_items(self)


    def set_max_noutput_items(self, m):
        """set_max_noutput_items(snr_sptr self, int m)"""
        return _fsmac_swig.snr_sptr_set_max_noutput_items(self, m)


    def unset_max_noutput_items(self):
        """unset_max_noutput_items(snr_sptr self)"""
        return _fsmac_swig.snr_sptr_unset_max_noutput_items(self)


    def is_set_max_noutput_items(self):
        """is_set_max_noutput_items(snr_sptr self) -> bool"""
        return _fsmac_swig.snr_sptr_is_set_max_noutput_items(self)


    def set_min_noutput_items(self, m):
        """set_min_noutput_items(snr_sptr self, int m)"""
        return _fsmac_swig.snr_sptr_set_min_noutput_items(self, m)


    def min_noutput_items(self):
        """min_noutput_items(snr_sptr self) -> int"""
        return _fsmac_swig.snr_sptr_min_noutput_items(self)


    def max_output_buffer(self, i):
        """max_output_buffer(snr_sptr self, int i) -> long"""
        return _fsmac_swig.snr_sptr_max_output_buffer(self, i)
    ...
    def set_max_output_buffer(self, *args):
        ...
        """
        return _fsmac_swig.snr_sptr_set_max_output_buffer(self, *args)


    def min_output_buffer(self, i):
        """min_output_buffer(snr_sptr self, int i) -> long"""
        return _fsmac_swig.snr_sptr_min_output_buffer(self, i)
    ...
    def set_min_output_buffer(self, *args):
        ...
        """
        return _fsmac_swig.snr_sptr_set_min_output_buffer(self, *args)


    def pc_noutput_items(self):
        """pc_noutput_items(snr_sptr self) -> float"""
        return _fsmac_swig.snr_sptr_pc_noutput_items(self)


    def pc_noutput_items_avg(self):
        """pc_noutput_items_avg(snr_sptr self) -> float"""
        return _fsmac_swig.snr_sptr_pc_noutput_items_avg(self)


    def pc_noutput_items_var(self):
        """pc_noutput_items_var(snr_sptr self) -> float"""
        return _fsmac_swig.snr_sptr_pc_noutput_items_var(self)


    def pc_nproduced(self):
        """pc_nproduced(snr_sptr self) -> float"""
        return _fsmac_swig.snr_sptr_pc_nproduced(self)


    def pc_nproduced_avg(self):
        """pc_nproduced_avg(snr_sptr self) -> float"""
        return _fsmac_swig.snr_sptr_pc_nproduced_avg(self)


    def pc_nproduced_var(self):
        """pc_nproduced_var(snr_sptr self) -> float"""
        return _fsmac_swig.snr_sptr_pc_nproduced_var(self)
    ...
    def pc_input_buffers_full(self, *args):
        ...
        """
        return _fsmac_swig.snr_sptr_pc_input_buffers_full(self, *args)
    ...
    def pc_input_buffers_full_avg(self, *args):
        ...
        """
        return _fsmac_swig.snr_sptr_pc_input_buffers_full_avg(self, *args)
    ...
    def pc_input_buffers_full_var(self, *args):
        ...
        """
        return _fsmac_swig.snr_sptr_pc_input_buffers_full_var(self, *args)
    ...
    def pc_output_buffers_full(self, *args):
        ...
        """
        return _fsmac_swig.snr_sptr_pc_output_buffers_full(self, *args)
    ...
    def pc_output_buffers_full_avg(self, *args):
        ...
        """
        return _fsmac_swig.snr_sptr_pc_output_buffers_full_avg(self, *args)
    ...
    def pc_output_buffers_full_var(self, *args):
        ...
        """
        return _fsmac_swig.snr_sptr_pc_output_buffers_full_var(self, *args)


    def pc_work_time(self):
        """pc_work_time(snr_sptr self) -> float"""
        return _fsmac_swig.snr_sptr_pc_work_time(self)


    def pc_work_time_avg(self):
        """pc_work_time_avg(snr_sptr self) -> float"""
        return _fsmac_swig.snr_sptr_pc_work_time_avg(self)


    def pc_work_time_var(self):
        """pc_work_time_var(snr_sptr self) -> float"""
        return _fsmac_swig.snr_sptr_pc_work_time_var(self)


    def pc_work_time_total(self):
        """pc_work_time_total(snr_sptr self) -> float"""
        return _fsmac_swig.snr_sptr_pc_work_time_total(self)


    def pc_throughput_avg(self):
        """pc_throughput_avg(snr_sptr self) -> float"""
        return _fsmac_swig.snr_sptr_pc_throughput_avg(self)


    def set_processor_affinity(self, mask):
        """set_processor_affinity(snr_sptr self, std::vector< int,std::allocator< int > > const & mask)"""
        return _fsmac_swig.snr_sptr_set_processor_affinity(self, mask)


    def unset_processor_affinity(self):
        """unset_processor_affinity(snr_sptr self)"""
        return _fsmac_swig.snr_sptr_unset_processor_affinity(self)


    def processor_affinity(self):
        """processor_affinity(snr_sptr self) -> std::vector< int,std::allocator< int > >"""
        return _fsmac_swig.snr_sptr_processor_affinity(self)


    def active_thread_priority(self):
        """active_thread_priority(snr_sptr self) -> int"""
        return _fsmac_swig.snr_sptr_active_thread_priority(self)


    def thread_priority(self):
        """thread_priority(snr_sptr self) -> int"""
        return _fsmac_swig.snr_sptr_thread_priority(self)


    def set_thread_priority(self, priority):
        """set_thread_priority(snr_sptr self, int priority) -> int"""
        return _fsmac_swig.snr_sptr_set_thread_priority(self, priority)


    def name(self):
        """name(snr_sptr self) -> std::string"""
        return _fsmac_swig.snr_sptr_name(self)


    def symbol_name(self):
        """symbol_name(snr_sptr self) -> std::string"""
        return _fsmac_swig.snr_sptr_symbol_name(self)


    def input_signature(self):
        """input_signature(snr_sptr self) -> io_signature_sptr"""
        return _fsmac_swig.snr_sptr_input_signature(self)


    def output_signature(self):
        """output_signature(snr_sptr self) -> io_signature_sptr"""
        return _fsmac_swig.snr_sptr_output_signature(self)


    def unique_id(self):
        """unique_id(snr_sptr self) -> long"""
        return _fsmac_swig.snr_sptr_unique_id(self)


    def to_basic_block(self):
        """to_basic_block(snr_sptr self) -> basic_block_sptr"""
        return _fsmac_swig.snr_sptr_to_basic_block(self)


    def check_topology(self, ninputs, noutputs):
        """check_topology(snr_sptr self, int ninputs, int noutputs) -> bool"""
        return _fsmac_swig.snr_sptr_check_topology(self, ninputs, noutputs)


    def alias(self):
        """alias(snr_sptr self) -> std::string"""
        return _fsmac_swig.snr_sptr_alias(self)


    def set_block_alias(self, name):
        """set_block_alias(snr_sptr self, std::string name)"""
        return _fsmac_swig.snr_sptr_set_block_alias(self, name)


    def _post(self, which_port, msg):
        """_post(snr_sptr self, swig_int_ptr which_port, swig_int_ptr msg)"""
        return _fsmac_swig.snr_sptr__post(self, which_port, msg)


    def message_ports_in(self):
        """message_ports_in(snr_sptr self) -> swig_int_ptr"""
        return _fsmac_swig.snr_sptr_message_ports_in(self)


    def message_ports_out(self):
        """message_ports_out(snr_sptr self) -> swig_int_ptr"""
        return _fsmac_swig.snr_sptr_message_ports_out(self)


    def message_subscribers(self, which_port):
        """message_subscribers(snr_sptr self, swig_int_ptr which_port) -> swig_int_ptr"""
        return _fsmac_swig.snr_sptr_message_subscribers(self, which_port)

snr_sptr_swigregister = _fsmac_swig.snr_sptr_swigregister
