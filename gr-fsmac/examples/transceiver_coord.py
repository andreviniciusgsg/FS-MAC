...
# Generated: Wed Nov 29 21:35:37 2017
##################################################
...
class transceiver_coord(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.fsmac_ml_decision_0 = fsmac.ml_decision(True, 0.01, "/home/gnuradio/out_file.txt", "/home/gnuradio/FS-MACplus/gr-fsmac/octave")
