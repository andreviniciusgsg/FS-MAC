...
# Generated: Sun Dec 17 12:51:24 2017
##################################################
...
class transceiver_s8(gr.top_block):
    ...
    def __init__(self):
        ...
        self.fsmac_tdma_0 = fsmac.tdma(8, 0, True, False)
        ...
        self.fsmac_csma_0 = fsmac.csma(8, 0, True)
...
def main(top_block_cls=transceiver_s8, options=None):
