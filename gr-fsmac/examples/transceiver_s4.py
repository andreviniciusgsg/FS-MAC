...
# Generated: Sun Dec 17 12:51:31 2017
##################################################
...
class transceiver_s4(gr.top_block):
    ...
    def __init__(self):
        ...
        self.fsmac_tdma_0 = fsmac.tdma(4, 0, True, False)
        ...
        self.fsmac_csma_0 = fsmac.csma(4, 0, True)
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.intern("12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890"), 1)
...
def main(top_block_cls=transceiver_s4, options=None):
